                ...
                <div class="tab-pane active" id="menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="@yield('patient_active')"><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Patient</span> </a>
                                <ul>
                                    <li class="@yield('patient_add_active')"><a href="{{ url('patients/add') }}">Add Patient</a></li>
                                    <li class="@yield('patient_list_active')"><a href="{{ route('patient.index') }}">All Patients</a></li>
                                    <li class="@yield('patient_document_add_active')"><a href="{{ route('patient-document.create') }}">Add Document</a></li>
